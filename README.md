...
book/                  AsciiDoc 원고 (4개 부, 10개 장)
  ...
  ch08-rag-pipeline.adoc           4부 8장. RAG 파이프라인과 검색의 원리
  ch09-korean-rag.adoc             4부 9장. 한국어 처리와 실무 구성
  ch10-rag-tuning.adoc             4부 10장. 성능 진단과 개선 우선순위
examples/
